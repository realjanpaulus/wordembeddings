...
def main():
    ...
    if args.model == "svm":
        ...
        pipe = Pipeline(steps=[("vect", vectorizer), ("clf", LogisticRegression())])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="svm",
        help="Indicates ML Model. Possible values: lr, svm.",
    )
    parser.add_argument(
        "--n_jobs",
        "-nj",
    ...
    parser.add_argument(
        "--stopwords", "-sw", action="store_true", help="Uses stopwords removal."
    )
